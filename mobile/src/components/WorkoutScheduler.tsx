...
export const WorkoutScheduler: React.FC<WorkoutSchedulerProps> = ({ plan, onPlanUpdated }) => {
    ...
    const handleRemoveWorkout = async (planItem: PlanItem) => {
        Alert.alert("Remove Workout", `Remove ${planItem.workout?.title} from this plan?`, [

...
export const WorkoutForm: React.FC<WorkoutFormProps> = ({ 
  ...
  useEffect(() => {
    if (category) {
      setWorkoutType(getWorkoutType(category as WorkoutCategory));
    }
  }, [category]);
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.subtitle}>This workout will be added to the global library for all users</Text>
      ...
      <View style={styles.inputGroup}>
        ...
        <View style={styles.typeDisplay}>
          <Text style={[
            ...
            { color: workoutType === WORKOUT_TYPES.CARDIO ? '#FF6B35' : '#007AFF' }
          ]}>

...
const IS_DEVELOPMENT = false; // This is true when running in development mode

// Backend URLs, run ipconfig getifaddr en0 to get IP
// const LOCAL_BACKEND_URL = "http://192.168.86.32:3001/api";
const LOCAL_BACKEND_URL = 'http://192.168.1.170:3001/api';
const CLOUD_BACKEND_URL =
    "https://workoutplannerservice-7jtitiinr-nanas-projects-294a362f.vercel.app/api";
